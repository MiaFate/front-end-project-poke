...
const HomeCard = ({ name, setAlert }) => {
	...
	if (pokemon) {
		return (
			<div className='shadow hover:shadow-2xl max-w-sm w-full rounded overflow-hidden flex flex-col justify-center items-center m-2 px-1 py-2 border border-gray-300'>
